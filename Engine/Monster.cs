...
namespace Engine
{
    public class Monster : LivingCreature
    {
        ...
        public Monster(int id, string name, int maxDamage, int rewardExperiencePoints, int rewardGold, int currentHealth, int maxHealth)
        ...
        {
            Monster newMonster =
                new Monster(ID, Name, MaxDamage, RewardExperiencePoints, RewardGold, CurrentHealth, MaxHealth);
