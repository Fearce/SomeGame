...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public void MoveTo(Location location)
        {
            ...
            {
                PlayerHasQuest(location);
            }

            SetTheCurrentMonsterForTheCurrentLocation(location);
        }

        private void PlayerHasQuest(Location location)
        {
        ...
        {
            int damage = RandomNumberGenerator.NumberBetween(weapon.MinDamage, weapon.MaxDamage);
        ...
        public string ToXmlString()
        {
            ...
            CreateNewChildXmlNode(playerData, stats, "CurrentHitPoints", CurrentHealth);
            CreateNewChildXmlNode(playerData, stats, "MaximumHitPoints", MaxHealth);
        ...
        {
            CurrentHealth = Math.Min(CurrentHealth + hitPointsToHeal, MaxHealth);
        }
